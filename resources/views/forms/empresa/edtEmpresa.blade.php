                ...
                <div class="card">
                  ...
                  <div class="row card-header sub-header">
                        <div class="col s12 m12 herramienta">
                          <a class="hide btn-floating waves-effect waves-light grey lighten-5 tooltipped" href="{{ url('/empresa/nuevo') }}" data-position="top" data-delay="500" data-tooltip="Nuevo">
                          ...
                          <a id="add" class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" type="submit" name="action" data-position="top" data-delay="500" data-tooltip="Guardar">
                        ...
                        <div class="card-content">
                            ...
                            <div class="row"> 
                              <div class="input-field col s12 m12 l12">
                                ...
                                <label for="representante1">Nombre Completo</label>
                              </div>     
                              <div class="input-field col s12 m12 l12">
