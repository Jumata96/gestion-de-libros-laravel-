<div id="updTipo" class="modal modal-fixed-footer" style="height: 100%; overflow: hidden;">
                                            ...
                                            <div class="card-content">                                               
                                              ...
                                              <div class="row">
                                                <div class="col s12 m8 l6 offset-l3 offset-m2">
                                                  <label for="u_idgrupo">Grupo</label>
                                                  <select class="browser-default" id="u_idgrupo" name="u_idgrupo" data-error=".errorTxt1" > 
                                                ...
                                                <div class="input-field col s12 m8 l6 offset-l3 offset-m2">
                                                  ...
                                                  <input id="u_idtipo" name="u_idtipo" type="text" data-error=".errorTxt2" value=" " disabled="">
                                                  <label for="u_idtipo">Código Grupo</label>
                                                  <div id="error1" style="padding-left: 3rem; color: red; font-size: 12px; font-style: italic;"></div>
                                                </div>      
