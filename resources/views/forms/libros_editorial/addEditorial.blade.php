      ...
      <form  id="myForm" accept-charset="UTF-8" enctype="multipart/form-data">
        <div class="row card-header sub-header">
          <div class="col s12 m12 herramienta">                         
            <a id="addAreas" class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" data-position="top" data-delay="500" data-tooltip="Guardar">
            ...
            <div class="card white">
              <div class="card-content">
                <div class="row">
                  ...
                  <div class="input-field col s12 m6 l12">
                    <i class="material-icons prefix">assignment</i>
                    <input id="dsCorta" maxlength="5" name="dsCorta" type="text" data-error=".errorTxt4" >
              ...
              <div class="card-content">
                <div class="row">
                  <div class="input-field col s12 m6 l12">
                    ...
                    <input id="email" name="email" type="text" data-error=".error2" maxlength="200" >
                    <label for="email"> Correo</label>
                    <div id="error7" style="padding-left: 3rem; color: red; font-size: 12px; font-style: italic;"></div>
                  </div>
                  <div class="input-field col s12 m6 l12">
                    <i class="material-icons prefix">call</i>
                    <input id="telefono" name="telefono" type="text" data-error=".errorTxt4" >
...
@endsection
@section('script')
@include('forms.libros_editorial.scripts.addEditorial') 
