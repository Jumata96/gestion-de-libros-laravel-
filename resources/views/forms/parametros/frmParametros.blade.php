...
<div class="row">
  <div class="col s12 m8 l6 offset-m2 offset-l3">
                <div class="card">
                  ...
                  <form class="formValidate right-alert" id="myForm" method="POST" action="{{ url('/usuario/grabar') }}" accept-charset="UTF-8" enctype="multipart/form-data">
                          ...
                          <div class="card-content">
                              ...
                              <div class="row">
                                ...
                                @foreach($parametros as $val)
                                  ...
                                  <input type="hidden" name="tipo_parametro" value="{{ $val->tipo_parametro }}">
