...
console.log(data);
      ...
      //console.log(data);
        ...
        $.ajax({
                ...
                url: "{{ url('dgeneral/iactualizar') }}" + '?' + $('#u_myForm').serialize(),
                method: "POST",               
                data: formData,
                processData: false,
                contentType: false
    ...
    @foreach ($dgeneral as $val)
      $(document).on('click','#upd_DGeneral{{$val->id}}', function(){
