  ...
  <div class="col s12 m12 l12">
                <div class="card">
                  <div class="card-header">                    
                    ...
                    <h2>Mantenedor Sección 01</h2>
                  </div>
                 <form class="formValidate right-alert" id="formGeneral" method="POST" action="{{ url('/vision/grabar') }}" accept-charset="UTF-8" enctype="multipart/form-data">
...
<div class="row">
  <div class="col s12 m12 l12">
                <div class="card">
                  ...
                  <div class="card-header" style="height: 50px; padding-top: 5px; background-color: #f6f6f6">
                        <div class="col s12 m12">
                          <a href="#addDGeneral" id="limpiar" class="btn-floating waves-effect waves-light grey lighten-5 modal-trigger">
                        ...
                        @include('forms.scripts.modalInformacion')  
                        @include('forms.nosotros.addDGeneral')  
                        @include('forms.nosotros.updDGeneral')  
                  </div>
                                    
                  <div class="row">
                   
                   @foreach($dgeneral as $datos)
                   <div class="col s12 m12 l3 item" style="padding-top: 1.5rem">
                    <div class="card" style="overflow: hidden;">
                      ...
                      <ul class="card-action-buttons">
                        <li style="margin: 0px; padding: 0px">
                          <a href="#updDGeneral" id="upd_DGeneral{{$datos->id}}" class="btn-floating waves-effect waves-light indigo accent-2 tooltipped modal-trigger" data-position="top" data-delay="500" data-tooltip="Ver" data-id="{{$datos->id}}" data-imagen="{{$datos->imagen}}" data-titulo="{{$datos->titulo}}" data-descripcion="{{$datos->descripcion}}"  data-estado="{{$datos->estado}}" data-fila="{{$datos->fila}}" data-icono="{{$datos->icono}}" data-tipo="{{$datos->tipo_img_icon}}" data-idtipo="{{$datos->idtipo}}">
                     ...
                     @include('forms.nosotros.scripts.general.alertaConfirmacion')  
                    @include('forms.nosotros.scripts.general.alertaConfirmacion2')  
                    @include('forms.nosotros.scripts.general.alertaConfirmacion3')  
...
@section('script')
  @include('forms.nosotros.scripts.general.general')
  @include('forms.nosotros.scripts.general.updGeneral')
  @include('forms.nosotros.scripts.general.addDGeneral')  
  @include('forms.nosotros.scripts.general.updDGeneral')  
  @include('forms.nosotros.scripts.general.habilitar')  
  @include('forms.nosotros.scripts.general.desabilitar')  
  @include('forms.nosotros.scripts.general.delDGeneral')  
@endsection
