...
@foreach ($inicio_seccion_det01 as $item_sec03)
  ...
  <div class="col s12 m12 l12">
                <div class="card">
                  <div class="card-header">                    
                    ...
                    <h2>ACTUALIZAR ITEM A LA SECCI&Oacute;N 03</h2>
                  </div>
                  <form class="right-alert" id="MyForm" method="POST"   accept-charset="UTF-8" enctype="multipart/form-data">
                  <div class="row card-header sub-header">
                        <div class="col s12 m12 herramienta">                         
                          <a id="UpdSeccion01" class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" name="action" data-position="top" data-delay="500" data-tooltip="Guardar">
                            <i class="material-icons" style="color: #2E7D32">check</i>
                          </a>   
                          <a style="margin-left: 6px"></a>   
                          
                          <a href="{{url('/seccion03')}}" class="btn-floating right waves-effect waves-light grey lighten-5 tooltipped" href="#!" data-activates="dropdown2" data-position="top" data-delay="500" data-tooltip="Regresar">
                  ...
                  <div class="row">
                    ...
                    <input type="hidden" name="url_file" value="{{$item_sec03->url_file}}">
                    <input type="hidden" name="name_file" value="{{$item_sec03->name_file }}"> 
                    <input type="hidden" name="sec03_cod" value="{{$item_sec03->codigo }}"> 
                              ...
                              <div class="col s12">
                                <div class="file-field input-field col s12 "> 
                                  <div class="col s8 m8 l6 offset-s2 offset-m2 offset-l3 center" style="">
                                    <img src="{{asset('storage/'.$item_sec03->url_file)}}" alt="" id="avatarImage" class=" responsive-img valign profile-image teal lighten-5" style="height: 100%; width: 100%">
                                  </div> 
                            ...
                            <div class="row"> 
                              <div class="col s12 center">
                                ...
                                <div class="input-field col s12">
                                  ...
                                  <input id="titulo" name="titulo" type="text" data-error=".errorTxt2" maxlength="200" value="{{$item_sec03->titulo}}">
                                  <label for="titulo">Título</label>
                                   <div class="errorTxt1" id="h_error2" style="color: red; font-size: 12px; font-style: italic;"></div>
                                </div>       
                                <div class="input-field col s12">
                                  <i class="material-icons prefix">mode_edit</i>
                                  <textarea id="descripcion" name="descripcion" class="materialize-textarea" lenght="200" maxlength="200" value="" style="height: 100px">{{$item_sec03->descripcion}}</textarea>
       ...
       // $Input = $('#archivo');
        $myForm = $('#MyForm');  
		  ...
		  $.ajax({
				...
				url: "{{ url('/seccion03/actualizar') }}" + '?' + $myForm.serialize(),
				method: 'POST',               
				data: formData,
				processData: false,
				contentType: false,
