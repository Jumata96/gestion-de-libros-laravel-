  ...
  <div class="col s12 m12 l12">
                <div class="card">
                  <div class="card-header">                    
                    ...
                    <h2>AGREGAR ITEM A LA SECCION 03</h2>
                  </div>
                  <form class="right-alert" id="MyForm" method="POST"   accept-charset="UTF-8" enctype="multipart/form-data">
                  <div class="row card-header sub-header">
                        <div class="col s12 m12 herramienta">                         
                          <a id="guardarSeccion03" class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" name="action" data-position="top" data-delay="500" data-tooltip="Guardar">
...
@section('script')
 ...
 <script>
	$('#guardarSeccion03').click(function(e){
	  e.preventDefault();    
	  var $Input, $myForm; 
       // $Input = $('#archivo');
        $myForm = $('#MyForm');  
		  ...
		  $.ajax({
				...
				url: "{{ url('/seccion03/grabar') }}" + '?' + $myForm.serialize(),
				method: 'POST',               
				data: formData,
				processData: false,
				contentType: false,
