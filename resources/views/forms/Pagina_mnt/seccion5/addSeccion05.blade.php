  ...
  <div class="col s12 m12 l12">
                <div class="card">
                  <div class="card-header">                    
                    ...
                    <h2>AGREGAR ITEM A LA SECCION 05</h2>
                  </div>
                  <form class="right-alert" id="MyForm" method="POST"   accept-charset="UTF-8" enctype="multipart/form-data">
                  <div class="row card-header sub-header">
                        <div class="col s12 m12 herramienta">                         
                          <a id="guardarSeccion04" class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" name="action" data-position="top" data-delay="500" data-tooltip="Guardar">
                            ...
                            <div class="row"> 
                              <div class="col s12 center">
                                ...
                                <div class="input-field col s12">
                                  ...
                                  <input id="precio" name="precio" type="number" data-error=".errorTxt2" maxlength="200">
...
@section('script')
 ...
 <script>
	$('#guardarSeccion04').click(function(e){
	  e.preventDefault();    
	  var $Input, $myForm; 
       // $Input = $('#archivo');
        $myForm = $('#MyForm');  
		  ...
		  $.ajax({
				...
				url: "{{ url('/seccion05/grabar') }}" + '?' + $myForm.serialize(),
				method: 'POST',               
				data: formData,
				processData: false,
				contentType: false,
