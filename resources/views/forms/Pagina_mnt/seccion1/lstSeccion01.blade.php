	...
	<div class="col s12 m12 l12">
					  <div class="card">
						 <div class="card-header">                    
							...
							<h2>SECCI&Oacute;N 01</h2>
						 </div>
						
						 <div class="card-header" style="height: 50px; padding-top: 5px; background-color: #f6f6f6">
								 <div class="col s12 m12">
									<a class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" href="{{ url('seccion01-nuevo') }}" data-position="top" data-delay="500" data-tooltip="Nuevo">
						 ...
						 <div class="row cuerpo">
							<?php 
							  ...
							  if (count($inicio_seccion_det01) > 0) {
								 # code...
								 $bandera = true;
								 $i = 0;
							  }
						 ...
						 <div class="row">
							<div class="col s12 m12 l12">
								 ...
								 <div class="card-content">
									Existen <?php echo ($bandera)? count($inicio_seccion_det01) : 0; ?> registros. <br><br>
                          ...
                          <th>Fecha creación</th>
										  ...
										  <tbody>
											<tr>
											  <?php 
													foreach ($inicio_seccion_det01 as $datos) {
													$i++;
													$e=0; 
												?>
                            <td><?php echo $i; ?></td>
                            ...
                            <img src="{{asset('/storage/'.$datos->url_file)}}" alt="" class="circle responsive-img valign profile-image teal lighten-5" style="height: 50px; width: 50px">
												  ...
												  <td class="center" style="width: 9rem">
													 <a href="{{ url('/seccion01-mostrar') }}-{{$datos->codigo}}" class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" data-position="top" data-delay="500" data-tooltip="Ver">
											  ...
											  @include('forms.inicio.seccion1.scripts.alertaConfirmacion') 
											  @include('forms.inicio.seccion1.scripts.alertaConfirmacion2') 
											  @include('forms.inicio.seccion1.scripts.alertaConfirmacion3')  
