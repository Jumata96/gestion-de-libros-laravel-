<div id="addGrupo" class="modal modal-fixed-footer" style="height: 100%; overflow: hidden;">
                                            ...
                                            <div class="card-content">                                               
                                              ...
                                              <div class="row">
                                                <div class="input-field col s12 m8 l6 offset-l3 offset-m2">
                                                  ...
                                                  <input id="idgrupo" name="idgrupo" type="text" data-error=".errorTxt2">
                                                  <label for="idgrupo">Código Grupo</label>
