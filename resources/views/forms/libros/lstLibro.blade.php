					  ...
					  <div class="card">
						 ...
						 <div class="card-header" style="height: 50px; padding-top: 5px; background-color: #f6f6f6">
								 <div class="col s12 m12">
									<a class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" href="{{ url('libros-nuevo') }}" data-position="top" data-delay="500" data-tooltip="Nuevo">
											  ...
											  <?php 
												...
												?>
												  ...
												  <td class="center" style="width: 9rem">
													 <a href="{{ url('/libros-mostrar') }}-{{$datos->codigo}}" class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" data-position="top" data-delay="500" data-tooltip="Ver">
