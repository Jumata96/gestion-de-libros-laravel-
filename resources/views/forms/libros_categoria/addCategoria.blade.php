                ...
                <div class="card">
                  ...
                  <div class="row card-header sub-header">
                        <div class="col s12 m12 herramienta">                         
                          <a id="addCategoria" class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" data-position="top" data-delay="500" data-tooltip="Guardar">
...
@section('script')
  @include('forms.libros_categoria.scripts.addCategoria') 
