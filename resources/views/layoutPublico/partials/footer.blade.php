                      ...
                      <div class="footer-content contact-info  footer-block">
                        <div id="contact-info-container" class="contact-info-inner">
                          <ul class="site-footer__linklist">
                            <li class="site-footer__linklist-item shop-contact col-lg-4 col-md-4 col-sm-4 col-xs-12 bottom-space">
                            ...
                            <li class="site-footer__linklist-item shop-email col-lg-4 col-md-4 col-sm-4 col-xs-12 bottom-space">
                              <i class="fa fa-envelope" aria-hidden="true"></i>
                              <div class="content">
                                <div class="title">Email</div>
                                <a href="mailto:	luis.pajess@gmail.com">
                                luis.pajess@gmail.com
                                </a>  
                              </div>
                            </li>
                            <li class="site-footer__linklist-item shop-address col-lg-4 col-md-4 col-sm-4 col-xs-12 bottom-space">
                              <i class="fa fa-map-marker" aria-hidden="true"></i>
                              <div class="content">
                                <div class="title">localización</div>
                                <p>4005, Trujillo - La Libertdad</p>
                                <p>Peru</p>
                              </div>
                            </li>
                          </ul>
                    ...
                    <div class="footer-container col-md-12 col-sm-12 col-xs-12" >
                      ...
                      <div class="bottom-link-list col-md-2 col-sm-12 footer-block">
                        ...
                        <div id="conpany-info-container" class="conpany-info-inner  collapse footer-dropdown">
                          ...
                          <ul class="site-footer__linklist">
                            ...
                            <li class="site-footer__linklist-item">
                              <a href="/pages/contact">Sitemap</a>
                            </li>
                            <li class="site-footer__linklist-item">
                              <a href="/pages/faqs">Secure Payment</a>
                            </li>
                          </ul>
                        </div>
                      </div>
                      <div class="bottom-link-list col-md-2 col-sm-12 footer-block">
                        <div class="footer-title clearfix hidden-lg-up collapsed" data-target="#product-info-container" data-toggle="collapse">
                          <span class="h3 block-heading">PRODUCT</span>
                          <span class="navbar-toggler collapse-icons">
                          <i class="material-icons add">&#xE313;</i>
                          <i class="material-icons remove">&#xE316;</i>
                          </span>
                        ...
                        <div id="product-info-container" class="product-info-inner  collapse footer-dropdown">
                          <h2 class="footer-heading hidden-lg-down">PRODUCT</h2>
                          <ul class="site-footer__linklist">
                            <li class="site-footer__linklist-item">
                              <a href="/pages/faqs">Delivery</a>
                            </li>
                            <li class="site-footer__linklist-item">
                              <a href="/collections/new-book">Prices Drop</a>
                            </li>
                            <li class="site-footer__linklist-item">
                              <a href="/collections/new-book">New Products</a>
                            </li>
                            <li class="site-footer__linklist-item">
                              <a href="/collections/special-book">Best Sales</a>
                            </li>
                            <li class="site-footer__linklist-item">
                              <a href="/collections/books">Stores</a>
                            </li>
                          </ul>
                        </div>
                      </div>
                        ...
                        <div class="newsletter-section col-md-3 col-sm-12">
                          <div class="newsletter-block">
                            <div class="newsletter_text">
                              ...
                              <p class="sub-heading">Leave your email to get all hot deals , exctra discount &amp; news which benefit you most!</p>
                            </div>
                                    ...
                                    <button type="submit" class="btn newsletter__submit" name="commit" id="Subscribe">
                                      <div class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                                          <symbol id="email" viewBox="0 0 900 900">
                                            <title>email</title>
                                        ...
                                        <svg class="icon" viewBox="0 0 40 40">
                                          <use xlink:href="#email" x="20%" y="20%"></use>
                                        </svg>
                                      </div>
                                    </button>
                                  </span>
                            ...
                            <div class="social-icon-inner">
                              <div class="header-social">
                                <ul class="list--inline site-footer__social-icons social-icons">
                                  <li class="facebook">
                                    <a class="social-icons__link" href="/" title="Creative Sectioned Shopify Theme on Facebook" target="_blank">
                                    <i class="fa fa-facebook" aria-hidden="true"></i>
                                    <span class="icon__-text">Facebook</span>
                                    </a>
                                  </li>
                                  <li class="twitter">
                                    <a class="social-icons__link" href="/" title="Creative Sectioned Shopify Theme on Twitter" target="_blank">
                                    <i class="fa fa-twitter" aria-hidden="true"></i>
                                    <span class="icon__-text">Twitter</span>
                                    </a>
                                  </li>
                                  <li class="pinterest">
                                    <a class="social-icons__link" href="/" title="Creative Sectioned Shopify Theme on Pinterest" target="_blank">
                                    <i class="fa fa-pinterest-p" aria-hidden="true"></i>
                                    <span class="icon__-text">Pinterest</span>
                                    </a>
                                  </li>
                                  <li class="instagram">
                                    <a class="social-icons__link" href="/" title="Creative Sectioned Shopify Theme on Instagram" target="_blank">
                                    <i class="fa fa-instagram" aria-hidden="true"></i>
                                    <span class="icon__-text">Instagram</span>
                                    </a>
                                  </li>
                                  <li class="tumblr">
                                    <a class="social-icons__link" href="/" title="Creative Sectioned Shopify Theme on Tumblr" target="_blank">
                                    <i class="fa fa-tumblr" aria-hidden="true"></i>
                                    <span class="icon__-text">Tumblr</span>
                                    </a>
                                  </li>
                                  <li class="youtube">
                                    <a class="social-icons__link" href="/" title="Creative Sectioned Shopify Theme on YouTube" target="_blank">
                                    <i class="fa fa-youtube-play" aria-hidden="true"></i>
                                    <span class="icon__-text">YouTube</span>
                                    </a>
                                  </li>
                                  <li class="vimeo">
                                    <a class="social-icons__link" href="/" title="Creative Sectioned Shopify Theme on Vimeo" target="_blank">
